...
# -----------------------
MONGO_URI = os.environ.get('MONGO_URI', 'mongodb+srv://derick1:derick123@crm-cluster.ysyhfh9.mongodb.net/crm_db?appName=crm-cluster')
MONGO_DB = os.environ.get('MONGO_DB', 'crm_db')
