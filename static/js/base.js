...
document.addEventListener("DOMContentLoaded", () => {
  ...
  try {
    ...
    console.error("[v0] Error initializing sidebar:", e)
  }
  
  try {
    initializeSearch()
  } catch (e) {
    console.error("[v0] Error initializing search:", e)
  }
  
  try {
    initializeAnimations()
  } catch (e) {
    console.error("[v0] Error initializing animations:", e)
  }
  
  try {
    updateActiveNav()
  } catch (e) {
    console.error("[v0] Error updating active nav:", e)
  }
  ...
  setTimeout(() => {
    try {
      ...
      console.error("[v0] Error updating nav counters:", e)
    }
    
    try {
      loadHomeStats()
    } catch (e) {
      console.error("[v0] Error loading home stats:", e)
    }
    
    try {
      loadRecentActivities()
    } catch (e) {
      console.error("[v0] Error loading recent activities:", e)
    }
    
    try {
      loadNotifications()
    } catch (e) {
      console.error("[v0] Error loading notifications:", e)
    }
